...
from assets.assets.TMBasic import ConflictGraph, ConflictGraphNode
        ...
        examples=[ 
            ...
            "result": 
                (
                    ...
                    (
                        # proof_rc
                        {(1, "y", 2, True), (2, "y", 1, False), (1, "z", 2, False), (2, "z", 1, False)},
                        # proof_aca
                        {(1, "y", 2, True)},
                        # proof_st
                        {}
            ...
            "result": 
                (
                    ...
                    (
                        # proof_rc
                        {(1, "y", 2, False), (2, "y", 1, False), (1, "z", 2, False), (2, "z", 1, False)},
                        # proof_aca
                         {(1, "y", 2, False), (2, "y", 1, False), (1, "z", 2, False), (2, "z", 1, False)},
                        # proof_st
                        {("w_2(y)", "w_1(y)", False, True), ("w_2(y)", "r_1(y)", False, True)}
                    )
                )
            },
        ]
